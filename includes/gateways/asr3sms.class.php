...
class asr3sms extends WP_SMS {
	...
	public function SendSMS() {
		...
		$response = wp_remote_get( $this->wsdl_link . 'sendsms.php?username=' . $this->username . '&password=' . $this->password . '&message=' . $this->msg . '&numbers=' . implode( ',', $this->to ) . '&sender=' . $this->from . '&unicode=e&Rmduplicated=1&return=json' );
